...
<View style={styles.container}>
    ...
    <ScrollView
        ...
        <View style={styles.filterView}>       
            <View style={styles.addressView}>
                <View style={{flexDirection :"row",alignItems:'center',paddingLeft:10}}>
                    ...
                    <Text style={{marginLeft:5}}>123 Xuân Phương</Text>
                </View>
                ...
                <View style={styles.clockView}>
                    ...
                    <Text style={{marginLeft:5}}>Dự kiến</Text>
                </View>
            </View>
        ...
        <View style ={styles.headerTextView}>
            <Text style ={styles.headerText}>Freeship ngay</Text>
        </View>

        <View>

            <View style = {{flexDirection : 'row', alignItems:'center'}}>
                <Text style ={{marginLeft:15,fontSize:16,marginTop:-10,marginRight:5,color:'red',fontStyle:'italic',fontWeight:'bold'}}>Flash Sale</Text>
                <CountDown
                    until={3600}
                    size ={14}
        ...
        <View style ={styles.headerTextView}>
            <Text style ={styles.headerText}>Món ngon gần bạn</Text>
        </View>
